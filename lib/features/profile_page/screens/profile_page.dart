import 'package:blackcoffer_assignment/features/profile_page/controller/profile_controller.dart';
import 'package:blackcoffer_assignment/features/profile_page/repository/profile_repository.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context  ) {
    return Scaffold(
      ...
      body:FutureBuilder(future: ProfileRepository().getVideoList(widget.uid), builder: (context , snapshot){
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            IconButton(onPressed: ()async {
                                              await ProfileController().deleteVideo(userdata[index].vid, context);
